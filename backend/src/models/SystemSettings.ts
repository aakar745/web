...
SystemSettingsSchema.statics.getCurrentSettings = async function(): Promise<ISystemSettings> {
...
interface SystemSettingsModel extends mongoose.Model<ISystemSettings> {
  getCurrentSettings(): Promise<ISystemSettings>;
  updateSettings(updates: Partial<ISystemSettings>): Promise<ISystemSettings>;
}

const SystemSettings = mongoose.model<ISystemSettings, SystemSettingsModel>('SystemSettings', SystemSettingsSchema);
